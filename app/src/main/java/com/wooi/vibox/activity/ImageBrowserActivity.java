...
import com.wooi.vibox.adapter.ImageBrowserAdapter;
...
public class ImageBrowserActivity extends BaseActivity implements OnClickListener {
	...
	private List<PictureUrl> imgUrls;
	...
	private void setData() {
		...
		vp_image_brower.setOnPageChangeListener(new OnPageChangeListener() {
			...
			public void onPageSelected(int arg0) {
				...
				PictureUrl pic = adapter.getPic(arg0);
				btn_original_image.setVisibility(View.VISIBLE);
			}
	...
	public void onClick(View v) {
		PictureUrl picUrl = adapter.getPic(vp_image_brower.getCurrentItem());
