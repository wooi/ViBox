...
import com.wooi.vibox.util.DisplayUtils;
...
public class ImageBrowserAdapter extends PagerAdapter {
	...
	public ImageBrowserAdapter(Activity context, List<PictureUrl> picUrls) {
	...
	public View instantiateItem(ViewGroup container, int position) {
		...
		PictureUrl picUrl = picUrls.get(index);
		
		String url = picUrl.getThumbnail_pic();
	...
	public PictureUrl getPic(int position) {
